...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-cf-bg px-6 text-center">
      {/* Glow */}
      <div
        aria-hidden="true"
      ...
      <div className="relative z-10 max-w-md">
        ...
        {/* 404 */}
        <p className="mb-2 text-8xl font-black tracking-tight text-cf-violet/20">404</p>
        ...
        <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
          ...
          <Link
            href="/dashboard"
            className="rounded-lg border border-cf-violet/25 px-6 py-2.5 text-sm font-semibold text-zinc-300 transition hover:border-cf-violet/40 hover:text-zinc-100"
          >
            Go to dashboard
          </Link>
        </div>
